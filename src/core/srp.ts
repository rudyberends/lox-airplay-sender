...
const sha1: any = require('js-sha1');
const memoize: any = require('lodash/memoize');
import { hexString2ArrayBuffer } from '../utils/util';

// ...

const groups: Record<number, { N: any; g: any }> = {
    1024: {
        N: new bigInt(
